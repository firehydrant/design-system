...
import { Menu, ButtonDropdown, IconButtonDropdown } from './Menu';
...
export const GroupedMenuTemplateWithSecondaryButton = () => (
  <ButtonDropdown buttonText={"Open Me"} buttonVariant="secondary" maxWidth="300px">
...
export const GroupedMenuTemplateWithTertiaryButton = () => (
  <ButtonDropdown buttonText={"Open Me"} buttonVariant="tertiary" maxWidth="300px">
    {groupedOptions.map(group => 
      <MenuGroup title={group.label}>
        {group.options.map(option =>
          <MenuItem
...
export const IconButtonMenuTemplate = () => (
